...
export function NFTCard({ nft }: { nft: VaultNFT }) {
  ...
  const posterSrc = hasDedicatedThumbnail ? nft.thumbnailWalrusUrl : undefined;
      ...
      <Card className="h-full overflow-hidden">
        <div className="p-3">
          {nft.mediaKind === 'image' ? (
            ...
            <MediaRenderer src={nft.walrusUrl} posterSrc={posterSrc} mimeType={nft.mediaType} kind={nft.mediaKind} title={nft.name} />
          )}
        </div>
